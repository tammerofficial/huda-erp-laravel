...
Route::middleware('auth')->group(function () {
    ...
    // Logout Route (POST - Preferred for security)
    ...
    // Logout Route (GET - Fallback for direct links)
    ...
    // User Routes (Super Admin & Admin Only)
    ...
    // Settings Routes (Super Admin & Admin Only)
    Route::middleware('role:super_admin,admin')->group(function () {
