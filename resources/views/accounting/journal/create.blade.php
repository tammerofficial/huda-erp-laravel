                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('debit_account') is-invalid @enderror" id="debit_account" name="debit_account" value="{{ old('debit_account') }}" required>
                                    @error('debit_account')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('credit_account') is-invalid @enderror" id="credit_account" name="credit_account" value="{{ old('credit_account') }}" required>
