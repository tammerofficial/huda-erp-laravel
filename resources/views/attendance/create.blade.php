...
<div class="container mx-auto p-6">
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg p-8">
            <h1 class="text-3xl font-bold mb-6 text-center">إضافة سجل حضور</h1>
            ...
            <form action="{{ route('attendance.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <!-- Check In Time -->
                    <div>
                        <label for="check_in" class="block text-sm font-medium text-gray-700 mb-2">وقت الدخول</label>
                    ...
                    <!-- Check Out Time -->
                    <div>
                        <label for="check_out" class="block text-sm font-medium text-gray-700 mb-2">وقت الخروج</label>
