...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">📈 Sales Reports</h1>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <div class="h-64 flex items-center justify-center bg-gray-50 rounded-lg">
            <div class="text-center">
                ...
                <p class="text-sm text-gray-400">Data will be available once orders are synced from WooCommerce</p>
            </div>
        </div>
    </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <tr>
                        <td colspan="5" class="px-6 py-4 text-center text-gray-500">
                            No sales data available yet. Orders will appear here once synced from WooCommerce.
                        </td>
                    </tr>
                </tbody>
            </table>
