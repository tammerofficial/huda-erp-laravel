...
@section('content')
<div x-data="bomEdit()" x-init="init()">
    <form method="POST" action="{{ route('bom.update', $billOfMaterial) }}" @submit="prepareSubmit">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white rounded-lg shadow-sm border p-6 mb-6">
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Update material requirements for production</p>
                </div>
